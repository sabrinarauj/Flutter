import 'dart:convert';
import 'package:app_tasks/screens/screens.local.dart';
...
class _TelaGetState extends State<TelaGet> {
  ...
  void fazerGet() async {
    final resposta_servidor = await http.get(
      Uri.parse("https://api-flutter-ayx5.onrender.com"),
    );
          ...
          children: [
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => TelaLocal()),
                );
              },
              child: Text("Ir para tela Local"),
            ),
          ],
        ),
      ),
